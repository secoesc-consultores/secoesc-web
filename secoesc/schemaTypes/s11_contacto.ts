...
export default {
  ...
  fields: [
    ...
    },
    {
      name: 'mapaImagen',
      type: 'image',
      title: '🖼️ Imagen del Mapa (Principal)',
      description: 'Imagen principal del mapa que se muestra por defecto.',
      options: { hotspot: true },
    },
    {
      name: 'mapaImagenHover',
      type: 'image',
      title: '📸 Imagen del Mapa (Al pasar el mouse)',
      description: 'Esta imagen aparecerá cuando el usuario pase el cursor sobre el mapa.',
      options: { hotspot: true },
    },
    {
      name: 'mapaUrl',
      ...
      description: 'Solo se usa si no hay imágenes subidas manualmente.',
    },
  ],
  preview: {
